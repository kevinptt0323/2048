...
AiInputManager.prototype.listen = function () {
  ...
  this.bindButtonPress(".ai-button", this.autoMove);

  self.on("moved", function(data) {
    var grid = data.grid, metadata = data.metadata;
...
AiInputManager.prototype.autoMove = function () {
  var nextStep = (Math.random()*4)|0;
  console.log("move " + nextStep);
